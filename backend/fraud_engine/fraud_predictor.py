...
DEFAULT_MODEL_PATH = os.path.join(os.path.dirname(__file__), '..', 'models', 'xgboost_model.pkl')
DEFAULT_PREPROCESSOR_PATH = os.path.join(os.path.dirname(__file__), '..', 'utils', 'preprocessor.pkl')
